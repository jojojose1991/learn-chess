...
| `pnpm add` re-resolved `zod` between two versions already in the lockfile and moved `@better-auth/utils` 0.4.2 to 0.5.0, riding in on a deploy change                                                                | a dependency bump anyone actually intends                                                                                                                    | `pnpm-lock.yaml`, this commit               |
